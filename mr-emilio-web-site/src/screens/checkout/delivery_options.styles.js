...
export const DeliveryScreenTransition = styled.div`
  width: 100%;
  min-height: 100vh;
  ...
  @media (max-width: ${({ theme }) => theme.breakpoints.mobile}) {
    animation: ${({ $isExiting, $direction }) => {
      ...
      if ($direction === "back") {
        return css`
          delivery-screen-back 260ms
            cubic-bezier(0.22, 1, 0.36, 1) both
        `;
      }

      return css`
        delivery-screen-forward 260ms
          cubic-bezier(0.22, 1, 0.36, 1) both
      `;
    }};

    @keyframes delivery-screen-enter {
      from {
        opacity: 0.96;
    ...
    @keyframes delivery-screen-forward {
      from {
        opacity: 1;
        transform: translateX(0);
      }
    ...
    @keyframes delivery-screen-back {
      from {
        opacity: 1;
        transform: translateX(0);
      }
