...
export const StoreSelectionSection = styled.section`
  width: 100%;
...
export const StoreSelectionSectionLabel = styled.h2`
  margin: 0 0 9px;
...
export const StoreSelectionCardButton = styled.button`
  display: block;
...
export const StoreSelectionCardLayout = styled.div`
  display: grid;
